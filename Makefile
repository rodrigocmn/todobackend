...
# Application service name - must match Docker Compose release specification application name
APP_SERVICE_NAME := app

# Build tag expresssion - can be used to evaluate a shell expression at runtime
...
buildtag:
	${INFO} "Tagging release image with sufix $(BUILD_TAG) and build tags $(BUILDTAG_ARGS)..."
...
# Get the container id of application service container
